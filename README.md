...
Part 6.  작업 분리와 병렬 운영 — Subagent / Worktree / Plan-First / 팀 자동화
   ↓        (여러 실행을 충돌 없이)
Part 7.  하네스 적용하기 — 앞의 원칙을 설정 파일 14개로 붙이는 법
   ↓        (개념 → 설정 파일과 습관)
...
| **[7. 하네스 적용하기](07.%20Part%207%20—%20하네스%20적용하기.md)** | **1단계 — 첫날** | CLAUDE.md `7-1` / Permissions `7-3` / 세션 위생 `7-12` |
| *(장 번호 없이 `7-N` 절 단위)* | **2단계 — 첫 주** | Rules `7-2` / Hooks `7-4` / Slash Commands `7-8` / Verification `7-11` / Plan·Thinking `7-13` |
| | **3단계 — 팀 확장** | Skills `7-5` / Sub-agents `7-6` / Worktree `7-10` / MCP `7-7` / Observability `7-9` / Plugins `7-14` |
